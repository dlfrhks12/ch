...
public class QnAController {
	...
	public ModelAndView read(@NonNull Integer qNo) {
		return new ModelAndView("main").addObject("viewName","center/read.jsp");
	}
	@GetMapping("/center/list")
	public ModelAndView list(@RequestParam(defaultValue = "1") int pageno, int qCano ) {
		return new ModelAndView("main").addObject("viewName", "center/list.jsp").addObject("page", service.list(pageno, qCano));
	}
