...
public class NoticeController {
	...
	public ModelAndView read(@NotNull Integer nNo, Principal principal ) {
		...
		return new ModelAndView("main").addObject("viewName", "notice/read.jsp").addObject("notice", service.read(nNo, aUsername));
	}
	@PreAuthorize("isAuthenticated()")
	@GetMapping("/notice/write")
	public ModelAndView write() {
		return new ModelAndView("main").addObject("viewName","notice/write.jsp");
	}
	@PreAuthorize("isAuthenticated()")
