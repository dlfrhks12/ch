...
<body>
      ...
      <div class="container">
         <div class="row" id="row">
            <div class="col-xl-9 mx-auto">
               <div class="map_wrap">
                  <div id="map"
                     style="width: 490px; height: 385px; position: relative; overflow: hidden;"></div>
                  <div id="menu_wrap" class="bg_white">
                     <div class="option">
                        <div id="place">
                           <form onsubmit="searchPlaces(); return false;">
                              <input type="text" placeholder="건물명, 도로명, 지번으로 검색하세요."
                                 value="인천  ICIA 교육원" id="keyword" size="32"
            ...
            <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
               <form id="search_frm" style="" name="" method="get"
                  action="/cheatingday/store_list">
                  <div class="form-row">
                     <svg type="button" width="1em" id="but" height="1em"
                     ...
                     <div class="col-12 col-md-9 mb-2 mb-md-0" id="hAddr">
                        <input name="keyword" class="form-control form-control-lg"
                           id="centerAddr" placeholder="우리동네로 검색하기">
                     </div>
   ...
   <script type="text/javascript"
      src="//dapi.kakao.com/v2/maps/sdk.js?appkey=74c86650f7cb8f6b997cf396f534dcc3&libraries=services"></script>
   <script type="text/javascript"
      src="//dapi.kakao.com/v2/maps/sdk.js?appkey=74c86650f7cb8f6b997cf396f534dcc3&libraries=LIBRARY"></script>
   <script type="text/javascript"
      src="//dapi.kakao.com/v2/maps/sdk.js?appkey=74c86650f7cb8f6b997cf396f534dcc3"></script>
   <script>
      //////////////////////////카카오 맵 API    //////////////////////////////////
                           ...
                           searchDetailAddrFromCoords(
                                 ...
                                 function(result, status) {
                                    if (status === kakao.maps.services.Status.OK) {
                                       var detailAddr = !!result[0].road_address ? '<div>도로명: '
