...
<div id="wrap">
		<form id="write_form" action="/cheatingday/manager/store_insert" method="post" enctype="multipart/form-data">
			...
			<div>
				...
				<div class="form-group">
					<input type="text" class="form-control" id="sNum" name="sNum" placeholder="음식점 고유번호를 입력해주세요">
				</div>
			</div>
			<div>
				<label for="sname_label">상호명</label>
				<div class="form-group">
					<input type="text" class="form-control" id="sName" name="sName" placeholder="상호명을 입력해주세요">
				</div>
			...
			<div class="form-group" style="text-align: center;">
				<button type="button" id="write" class="btn btn-info">음식점 추가</button>&nbsp;&nbsp;&nbsp;&nbsp;
			</div>
		</form>
	</div>
</body>
